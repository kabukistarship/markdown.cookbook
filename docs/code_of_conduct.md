...
The Code of Conduct (CoC) for this projects are linked to external sources that include the [Contributor Covenant CoC](https://www.contributor-covenant.org/version/1/4/code-of-conduct.html) and the [AStartup Cookbook](https://github.com/CookingWithCale/AStartupCookbook). You are required to read and agree to the following documents in order to contribute to this repository:

* [Change Control Procedure](https://github.com/CookingWithCale/KabukiPressCookbook/blob/master/change_management/change_control_proceedure.md)
