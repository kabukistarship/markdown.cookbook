...
**1.** Ensure the bug was not already reported by by reading the [Issues](https://github.com/CookingWithCale/MarkdownCookbook/issues).
...
**6.** Create a GitHub Pull Request at <https://github.com/CookingWithCale/MarkdownCookbook/pulls>.
